    ...
    <div className="min-h-screen flex flex-col overflow-x-hidden">
      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-24">
          ...
          >
            {[
              { name: "Kashmir", image: himalayanRetreat, tag: "Paradise on Earth" },
              { name: "Kerala", image: keralaBackwaters, tag: "God's Own Country" },
              { name: "Rajasthan", image: rajasthanHeritage, tag: "Land of Royals" },
              { name: "Varanasi", image: varanasiGhats, tag: "Spiritual Capital" },
