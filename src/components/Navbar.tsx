      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center ">
            <img alt="Anagha Safar" className="h-16 w-auto object-contain transition-transform duration-200 hover:scale-105" src="/lovable-uploads/ee677116-1ce7-4977-bf44-066fe376ce2e.png" />
          </Link>
